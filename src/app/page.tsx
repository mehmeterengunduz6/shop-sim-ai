...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#fafafa] px-4">
      {/* Badge */}
      <div className="flex items-center gap-2 mb-6 px-4 py-2 bg-white rounded-full border border-gray-200 shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-xl">
        <div className="flex items-center gap-3 bg-white rounded-full border border-gray-200 shadow-lg px-5 py-3">
          {/* Globe Icon */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="22"
